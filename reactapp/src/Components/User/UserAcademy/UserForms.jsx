...
const Forms = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userResponse = await axios.get(`https://8080-addebfabbbaecebadafdecbf.project.examly.io/user/${encodeURIComponent(storedEmail)}`);
      const userId = userResponse.data.userId;
      const instituteId = vdata.instituteId;
  
      await axios.post(`https://8080-addebfabbbaecebadafdecbf.project.examly.io/user/addAdmission/${courseId}/${instituteId}/${userId}`, formData);
