...
const EditEnrolled = () => {
    ...
    const fetchDetails = async () => {
      try {
        const response = await axios.get(
          `https://8080-addebfabbbaecebadafdecbf.project.examly.io/user/viewAdmission1?admissionId=${edit.admissionId}`
        );
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(
        `https://8080-addebfabbbaecebadafdecbf.project.examly.io/user/editAdmission/${edit.admissionId}`,
        updatedDetails
      );
