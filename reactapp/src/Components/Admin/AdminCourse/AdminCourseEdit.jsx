...
const AdminCourseEdit = () => {
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        const response = await axios.get(`https://8080-bfbccadaceacbbaecebadafdecbf.project.examly.io/admin/viewcoursebyCourseId/${course.courseId}`);
  ...
  useEffect(() => {
    const fetchInstitutes = async () => {
      try {
        const response = await axios.get("https://8080-bfbccadaceacbbaecebadafdecbf.project.examly.io/admin/viewonlyInstitutes");
  ...
  const handleUpdate = async () => {
    ...
    try {
       await axios.put(`https://8080-bfbccadaceacbbaecebadafdecbf.project.examly.io/admin/editCourse/${course.courseId}`, updatedCourse);
