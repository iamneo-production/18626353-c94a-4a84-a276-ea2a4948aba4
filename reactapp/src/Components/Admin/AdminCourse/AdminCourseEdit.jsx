...
const AdminCourseEdit = () => {
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        const response = await axios.get(`https://8080-caecdafbbaedcbbaecebadafdecbf.project.examly.io/admin/viewcoursebyCourseId/${course.courseId}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
       await axios.put(`https://8080-caecdafbbaedcbbaecebadafdecbf.project.examly.io/admin/editCourse/${course.courseId}`, updatedCourse);
