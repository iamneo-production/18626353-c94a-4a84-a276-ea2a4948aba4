...
useEffect (() => {
  ...
  const handleUpdate = (e) => {
    ...
    axios.put('https://8080-afbbeccfcdaebbaecebadafdecbf.project.examly.io/admin/editInstitute/'+id1,data)
    .then(response => {
  ...
  const handleEdit = (id1) => {
    axios.get('https://8080-afbbeccfcdaebbaecebadafdecbf.project.examly.io/admin/viewinstitutebyId/'+id1)
      .then((result) => {
