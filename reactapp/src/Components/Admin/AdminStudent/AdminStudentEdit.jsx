...
const EditStudent = () => {
  ...
  const [updateSuccess, setUpdateSuccess] = useState(false); 
    ...
    const fetchStudent = async () => {
      try {
        const response = await axios.get('https://8080-fadaceeecdbbaecebadafdecbf.project.examly.io/admin/viewstudentbyId/'+student.studentId);
    ...
    const fetchInstitutes = async () => {
      try {
        const response = await axios.get(
          "https://8080-fadaceeecdbbaecebadafdecbf.project.examly.io/admin/getinstituteCourses"
        );
  ...
  const handleUpdate = async () => {
    ...
    try{
      await axios.put(`https://8080-fadaceeecdbbaecebadafdecbf.project.examly.io/admin/editStudent/${student.studentId}`,updatedStudent);
