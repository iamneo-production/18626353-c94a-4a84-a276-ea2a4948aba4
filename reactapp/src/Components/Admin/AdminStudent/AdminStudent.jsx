...
const Adminstudent = () => {
  ...
  const fetchStudents = () => {
    axios
      .get( `https://8080-abbaedcbbaecebadafdecbf.project.examly.io/admin/ViewStudent`)
      .then((response) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      axios
        .delete(`https://8080-abbaedcbbaecebadafdecbf.project.examly.io/admin/deleteStudent/${id}`)
        .then((response) => {
...
const handleDeleteSelected = async () => {
  ...
  try {
    const deleteRequests = selectedStudents.map(id=> {
      return axios.delete('https://8080-abbaedcbbaecebadafdecbf.project.examly.io/admin/deleteStudent/'+id);
