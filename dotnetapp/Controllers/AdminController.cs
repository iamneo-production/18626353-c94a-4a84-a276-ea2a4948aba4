...
namespace dotnetapp.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        [HttpGet("admin/viewinstitutebyId/{instituteId}")]
        public async Task<IActionResult> viewinstitutebyId(int instituteId)
        {
        ...
        [HttpGet("admin/viewinstcoursebyId/{InstId}")]
        public IActionResult viewinstcoursebyId(int InstId)
        {
        ...
        [HttpGet("admin/viewcoursebyCourseId/{courseId}")]
        public async Task<IActionResult> viewcoursebyCourseId(int courseId)
        {
            var course = await dc.CourseModels.FindAsync(courseId);
            if (course == null)
            {
        ...
        public async Task<IActionResult> addStudent([FromBody] StudentModel student)
        {
            ...
            try
            {
                var course = await dc.CourseModels.FindAsync(student.CourseId);
                if(course == null)
                {
                    return NotFound("Course not found");
                }
        ...
        [HttpGet("admin/viewstudentbyId/{StudentId}")]
